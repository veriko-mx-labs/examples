...
- **SDK oficiales**: [Python](https://github.com/veriko-mx-labs/veriko-python) (`veriko`) y [JavaScript/TypeScript](https://github.com/veriko-mx-labs/veriko-js) (`@veriko-mx/sdk`). Para cualquier otro lenguaje, estos ejemplos y la [referencia completa](https://docs.veriko.mx/openapi.yaml).
